    ...
    <div @click.self="closeModal" class="modal-container">
      ...
      <div class="px-6 space-y-4 pb-4">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <div class="input-container">
              <input type="date" v-model="localFilters.fromDate" class="bg-white input text-sm text-gray-500" />
          ...
          <div>
            ...
            <div class="input-container">
              <input type="date" v-model="localFilters.toDate" class="bg-white input text-sm text-gray-500" />
              <!-- <LucideCalendar class="icon" /> -->
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <UiSelectField :model-value="localFilters.category" @update:modelValue="localFilters.category = $event"
            :options="supplierCategories" :placeholder="`All categories`" class="text-sm"
        ...
        <div>
          ...
          <UiSelectField :model-value="localFilters.status" @update:modelValue="localFilters.status = $event"
            :options="statuses" :placeholder="`All statuses`" class="text-sm" :reduce="(option) => option.name" />
