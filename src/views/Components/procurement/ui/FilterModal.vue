        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <div class="input-container">
              <input type="date" v-model="localFilters.fromDate" class="text-sm text-gray-500 bg-white input" />
          ...
          <div>
            ...
            <div class="input-container">
              <input type="date" v-model="localFilters.toDate" class="text-sm text-gray-500 bg-white input" />
              <!-- <LucideCalendar class="icon" /> -->
            </div>
          </div>
        </div>
