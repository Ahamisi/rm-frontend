    ...
    <div class="mx-auto px-4 py-3 flex items-center justify-between">
      ...
      <div class="flex items-center">
        ...
        <div class="flex items-center mr-6">
          <img src="@/views/Pages/procurement/redesign/logo.svg" alt="Procurement Logo" class="w-8 h-8" />
        ...
        <div class="relative">
          <button @click="toggleBranchDropdown"
      ...
      <div class="flex items-center space-x-6">
        ...
        <div class="relative cursor-pointer" @click="openModal">
          <Bell class="h-5 w-5 fill-gray-500 stroke-gray-500 stroke-2 rotate-45" />
        ...
        <div class="relative cursor-pointer" @click="toggleProfileMenu">
          <div class="h-7 w-7 bg-gray-500 rounded-full flex items-center justify-center">
...
import Notification from "@/views/Components/notifications/Notification.vue";
