  ...
  <nav class="relative z-40 hidden px-6 bg-white border-b sm:block app_navigation">
    <div class="mx-auto">
      <ul class="flex px-5 gap-x-4 navbar_menu">
        <li v-for="(item, index) in navItems" :key="index" class="text-center ">
...
const navigation: Record<string, any[]> = {
  ...
  outbound: [
    { label: "Dashboard", url: "/outbound/dashboard", icon: LayoutDashboard },
    { label: "All Orders", url: "/outbound/orders", icon: FileText },
