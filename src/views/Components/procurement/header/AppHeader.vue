<template>
  ...
  <header class="relative z-50 hidden px-6 bg-white border-b border-gray-200 shadow-sm md:block">
    <div class="flex items-center justify-between px-4 py-3 mx-auto">
      ...
      <div class="flex items-center">
        ...
        <div class="relative flex items-center gap-2 mr-6">
          ...
          <img src="@/views/Pages/procurement/redesign/logo.svg" alt="Procurement Logo" class="w-6 h-6" />
