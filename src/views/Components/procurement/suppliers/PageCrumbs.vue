  ...
  <div class="flex flex-col items-center gap-3 justify-between px-5">
    ...
    <div class="flex justify-start items-center gap-2 w-full">
      <nav class="text-gray-500 text-xs flex items-center gap-2">
        <router-link :to="{ name: 'suppliers' }" class="hover:underline">All Suppliers</router-link>
        /
        <router-link :to="{ name: 'supplier-details', params: { id: supplierId } }" class="hover:underline">{{ title
          }}</router-link>
        /
    ...
    <div class="flex justify-between w-full">
      <button @click="goBack" class="text-gray-700 flex items-center gap-2 justify-center">
      ...
      <div class="flex items-center gap-2">
        ...
        <button @click="$emit('edit')"
          ...
          ></LucidePencil> -->
          <!-- <img src="@/views/Pages/procurement/redesign/edit.svg" alt="" class="h-4 w-4 stroke-white" /> -->
