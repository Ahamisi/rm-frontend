...
import SuppliersDeleteModal from "@/views/Components/suppliers/DeleteModal.vue";
import SuppliersDropdownMenu from "@/views/Components/suppliers/DropdownMenu.vue";
...
<template>
    ...
    <table class="w-full">
      <thead>
        <tr class="bg-gray-100 text-center medium-text text-text-default">
          ...
          <th class="p-3 medium-text" @click="updateSpecificSort('supplierName')">
            Supplier Name
            <ChevronsUpDown class="inline w-[12px]" />
          </th>
          <th class="p-3 medium-text" @click="updateSpecificSort('contactName')">
            Contact Name
            <ChevronsUpDown class="inline w-[12px]" />
          </th>
      ...
      <tbody class="medium-text">
        <tr v-for="(supplier, id) in sortedSuppliers" :key="supplier.id"
          ...
          <td class="p-3 flex justify-center">
            <LucideEllipsisVertical @click="selectSupplier(id, supplier.id)"
          ...
          <SuppliersDropdownMenu v-if="selectedSupplier?.id == supplier.id" :isOpen="isDropdownOpen"
            @view="handleSelection" @close="isDropdownOpen = false" @purchase="handleAddPurchaseOrder"
  ...
  <SuppliersDeleteModal :isOpen="isModalOpen" :supplierName="selectedSupplier?.contactName" @close="isModalOpen = false"
