...
import AwaitingPo from "@/views/Components/procurement/purchase/supplierDetails/AwaitingPo.vue";
import ApprovedPo from "@/views/Components/procurement/purchase/supplierDetails/ApprovedPo.vue";
import UnconfirmedGrn from "@/views/Components/procurement/purchase/supplierDetails/UnconfirmedGrn.vue";
import ConfirmedGrn from "@/views/Components/procurement/purchase/supplierDetails/ConfirmedGrn.vue";
import PriceConfirmation from "@/views/Components/procurement/purchase/supplierDetails/PriceConfirmation.vue";
import CompletedPo from "@/views/Components/procurement/purchase/supplierDetails/CompletedPo.vue";
import Payments from "@/views/Components/procurement/purchase/supplierDetails/Payments.vue";
