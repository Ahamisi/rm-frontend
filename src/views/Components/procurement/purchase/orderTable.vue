            ...
            <slot :name="header.value" :row="row" v-if="header.value === 'assigned'">
              ...
              <div v-else class="flex justify-center space-x-1">
                <img class="w-6 h-6 rounded-full"
                  :src="row.assigned.image || '@/views/Pages/procurement/redesign/silhouette.svg'"
                  :alt="row.assigned" />
                <Tooltip :text="row.assigned">
...
import OrderDeleteModal from "@/views/Components/procurement/purchase/DeleteModal.vue";
import OrderLog from "@/views/Components/procurement/purchase/OrderLog.vue";
...
const handleOrderLog = () => {
  ...
  emit("orderLog", selectedOrder.value);
