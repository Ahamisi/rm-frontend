...
<template>
      ...
      <div class="w-full sm:w-[500px] bg-white h-full flex flex-col shadow-xl overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto px-6 py-4 space-y-6">
          <div>
            ...
            <SelectWithSearchField v-model="form.item" :options="products" @search="handleProductSearch"
              :is-searching="isSearching" placeholder="Type to search for item" />
          </div>
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <div class="relative">
                ...
                <input v-model="form.unit_cost" type="text"
            ...
            <div>
              ...
              <div class="relative">
                <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500">₦</span>
                <input v-model="form.price_per_pack" type="text"
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              <label class="block text-sm text-gray-600 mb-1">Item Quantity</label>
            ...
            <div>
              ...
              <input v-model="form.discount" type="number" class="w-full border rounded-lg px-3 py-2.5 medium-text" />
            </div>
          </div>
        </div>
  ...
  <DiscardModal @close="isDiscardOpen = !isDiscardOpen" @confirm="close(false)"
    :action="form.id ? 'Edit Item' : 'Add Item'" :isOpen="isDiscardOpen" />
</template>
