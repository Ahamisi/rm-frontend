...
<template>
  <div class="h-screen flex flex-col justify-center items-center bg-gradient-to-b from-white to-blue-100">
    <div class="flex gap-1 items-center justify-center mb-12">
      <img src="@/views/Pages/procurement/redesign/logo.svg" alt="Logo" class="w-12 h-12" />
      ...
      <form @submit.prevent="onSubmit">
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            <div class="absolute left-3 top-3.5 flex items-center gap-2">
              <img src="https://flagsapi.com/NG/flat/64.png" alt="Nigeria Flag" class="w-6 h-6 rounded-full" />
              <span class="text-gray-600 text-sm">+234</span>
            </div>
            <input type="text" v-model="phone" placeholder="8010202020" maxlength="10"
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            ...
            <div class="absolute right-3 top-4 cursor-pointer" @click="togglePassword">
