<template>
  <Teleport to="body">
    <transition name="fade">
      <div v-if="isOpen" class="fixed inset-0 bg-black/50 flex justify-center items-center z-[60]"
        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-sm p-5">
          ...
          <div class="flex items-center gap-2">
            ...
            <img src="@/views/Pages/procurement/redesign/trash-icon.png" class="w-5 h-5" />
          ...
          <p class="text-center text-sm text-gray-600 mb-6">
            ...
            <span class="font-bold">{{ paymentName || "this payment" }}</span>? This action cannot be undone.
          </p>
...
import ErrorIcon from "@/views/Components/procurement/icons/ErrorIcon.vue";
