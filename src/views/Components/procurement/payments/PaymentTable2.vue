...
import PaymentsDropdownMenu from "@/views/Components/payments/DropdownMenu.vue";
import PaymentsDeleteModal from "@/views/Components/payments/DeleteModal.vue";
import DownloadSuccess from "@/views/Components/ui/DownloadSuccess.vue";
import PaymentView from "@/views/Components/payments/PaymentView.vue";
...
<template>
  ...
  <PaymentView v-model="isViewOpen" @close="selectedPayment = null" :selectedPayment="selectedPayment" />
  <PaymentsDeleteModal :isOpen="isModalOpen" :paymentName="selectedPayment?.contactName" @close="isModalOpen = false"
    @confirm="handleDelete" />

  <teleport to="body">
    <div v-if="isDropdownOpen && selectedPayment?.id === payments[selectedId]?.id" :style="{
      position: 'absolute',
