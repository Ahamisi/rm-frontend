<template>
  <main class="bg-white px-12 py-3">
    ...
    <div class="text-[#626F86] mb-3 space-x-2">
      ...
      <span>/</span>
      <router-link to="/purchase">
        <span class="hover:underline cursor-pointer title-text" @click="close">Awaiting PO Approval</span>
      </router-link>
      <span>/</span>
      <router-link to="/">
    ...
    <div>
      <div class="flex items-center justify-between mb-4">
        ...
        <h2 class="page-title-text text-text-default">Create Purchase Order</h2>
        <div class="text-right text-xs font-semibold">
          <button @click="createPurchaseOrder" class="bg-blue-600 text-white px-6 py-2 rounded">
            Create
          </button>
        </div>
      </div>
        ...
        <div class="grid grid-cols-5 gap-4">
          ...
          <div>
            ...
            <input type="date" v-model="purchaseDate"
              class="w-full p-2 border-[2px] border-[#091E4224] rounded-lg placeholder:text-[#626F86]" />
          </div>
          <div>
      ...
      <div class="mt-6 p-4 rounded-xl bg-[#F7F8F9]">
        ...
        <div class="px-4 py-[10rem] bg-white rounded-md border border-[#091E4224] flex justify-center text-center">
          <div class="flex flex-col justify-center items-center shadow-[0px_0px_50px_0px_#E5E2E9] p-6 rounded-lg">
            ...
            <button class="bg-blue-600 text-white mt-5 px-3 py-1 rounded-lg flex items-center gap-1">
