<template>
  <main>
    <div class="flex justify-between items-center">
      <Search v-model:modelValue="search" v-model:isAscending="isAscending" v-model:selectedStatus="selectedStatus" />
      ...
      <button @click="createPurchaseOrder"
        ...
        <span class="text-lg mb-[2px]">+</span>
      ...
      <PurchaseOrderTable :headers="headers" :data="paginatedItems">
        <template #assigned="{ row }">
          <div class="flex items-center space-x-2">
            <img v-if="row.assigned.image" :src="row.assigned.image || defaultAvatar" alt="User Avatar"
              class="w-6 h-6 rounded-full" />
            <span :class="row.assigned.name === 'Unassigned'
              ? 'text-red-500'
              : 'text-gray-700'
              ">
              {{ row.assigned.name }}
...
import { usePagination } from "@/views/Composables/procurement/usePagination";
...
import CreatePurchaseOrder from "@/views/Components/purchase/createPurchaseOrder.vue";
...
const tableData: TableRow[] = [
  {
    ...
    date: "5/21/2024",
    totalAmount: 2055043,
    assigned: { name: "Unassigned", image: null },
  },
  {
    orderNo: "RHPO-1651244214",
    supplierName: "EVANS THERAPEUTICS LTD",
    type: "Trade",
    date: "5/21/2024",
    totalAmount: 2055043,
    assigned: { name: "Femi Babalola", image: defaultAvatar },
  },
  {
    orderNo: "RHPO-1651244214",
    supplierName: "EVANS THERAPEUTICS LTD",
    ...
    date: "5/21/2024",
    totalAmount: 2055043,
    assigned: { name: "Esther Joel", image: defaultAvatar },
  },
  {
    orderNo: "RHPO-1651244214",
    supplierName: "Fidson Healthcare",
  ...
  },
  {
    ...
    date: "5/21/2024",
    totalAmount: 2055043,
    assigned: { name: "Femi Babalola", image: femiAvater },
  },
  {
    orderNo: "RHPO-1651244214",
    supplierName: "Emzor Pharmaceuticals",
  ...
  },
  {
    ...
    date: "5/21/2024",
    totalAmount: 2055043,
    assigned: { name: "Sarah Badmus", image: janeAvater },
  },
  {
    orderNo: "RHPO-1651244214",
    supplierName: "Emzor Pharmaceuticals",
  ...
  },
  {
    ...
    date: "5/21/2024",
    totalAmount: 2055043,
    assigned: { name: "Josh Michael", image: joshAvater },
  },
];
