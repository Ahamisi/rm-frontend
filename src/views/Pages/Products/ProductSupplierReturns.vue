<template>
    <div class="px-6 pb-4 bg-white ">
        <Datatable :url="supplierReturnUrl" :filterByDate="false" :columns="columns"
            :pagename="`product${$route.params.id}SupplierReturns`" :key="childKey">
            <template #column="col">
...
const supplierReturnUrl = computed(() => import.meta.env.VITE_API_URL + `admin/products/${route.params.id}/supplier_returns`)
