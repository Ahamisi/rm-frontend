  ...
  <div class="erp_dashboard_wrapper">
    ...
    <div class="px-6 mt-0 bg-white min-h-[calc(100vh-190px)]">
      <Datatable
        ...
        :exportable="false"
        :filterFields="{}"
        pageName="ComplianceDamagedProducts"
        :key="childKey"
      >
    ...
    <SideBarModal
      ...
      :title="showEditModal ? 'Edit Damaged Product' : 'Create Damaged Product'"
...
const deleteMessage = computed(() => {
  return selectedProduct.value 
    ? `You are about to delete this damaged product "${selectedProduct.value.product_name}".`
    : 'You are about to delete this damaged product.';
});

const modalProcessName = computed(() => {
  return showEditModal.value ? 'Edit Damaged Product' : 'Create Damaged Product';
});
...
// Mock damaged products data - matching the image examples
