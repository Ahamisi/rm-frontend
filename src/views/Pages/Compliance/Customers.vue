            ...
            >
                <template #column="col">
                    ...
                    <span v-else-if="col.props?.column?.field === 'action'">
                        <TableActionDropdown :rowData="col.props?.formattedRow" :wide="true">
...
const dynamicTitle = computed(() => {
    const baseTitle = 'More Actions / All Customers'
    
    if (activeTab.value === 'Active Users') {
        return `${baseTitle} / Active Users`
    } else if (activeTab.value === 'Deactivated Users') {
        return `${baseTitle} / Deactivated Users`
    }
