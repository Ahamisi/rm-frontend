<template>
  <div class="flex-1 flex flex-col min-h-0">
    <Datatable 
      ...
      :columns="columns" 
      pageName="Being Processed Orders"
    >
      <template #column="col">
        <!-- Tags Column -->
...
// Mock data for being processed orders
const orders = ref([
  {
    id: 1,
    orderNo: 'RHPO-1651244 230',
