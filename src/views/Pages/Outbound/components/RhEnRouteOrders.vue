<template>
  <div>
    <Datatable
      :items="rhEnRouteOrders"
      :columns="rhEnRouteOrderColumns"
      :searchable="true"
      :filterByDate="false"
      :printable="false"
      :exportable="false"
      :filterFields="{}"
      pageName="RhEnRouteOrders"
      :key="childKey"
    >
      <template #column="col">
        <!-- Action Column -->
...
// Column definitions
const rhEnRouteOrderColumns = ref<TableColumn[]>([
...
<style scoped>
/* Add any specific styles for RH En Route Orders */
</style>
