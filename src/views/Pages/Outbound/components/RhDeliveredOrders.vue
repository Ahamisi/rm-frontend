...
const orderActivities = ref([
  ...
  },
  {
    ...
    description: 'Status changed from En Route to Delivered',
    user: 'System',
    timestamp: '2024-01-15 14:25:00',
    details: 'Automatic status update upon delivery confirmation'
  },
  {
    id: 3,
    ...
    details: 'Package handed over to delivery partner'
  }
]);
