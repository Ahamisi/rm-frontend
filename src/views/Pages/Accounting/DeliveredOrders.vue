<template>
  ...
  <div class="px-6 erp_dashboard_wrapper">
    <!-- Header -->
    <PageTitle title="Orders & Fulfilment / Delivered Orders" />
    ...
    <div class="min-h-[calc(100vh-190px)]" v-else>
      <Datatable
        ...
        :key="childKey"
        pageName="AccountingDeliveredOrders" 
      >
    ...
    <SideBarModal 
      :isOpen="showFulfillmentDetailsModal" 
      width="70%" 
    ...
    >
      <template #header>
        <OrderHeader 
          ...
          :reference="selectedOrder.order_no || ''"
          titleSize="md"
        >
          <template #icon>
...
// Table columns
const deliveredColumns: TableColumn[] = [
...
// All mock data for delivered orders
const allDeliveredOrders = ref([
  { id: 1, order_no: 'RHPO-1651244214', customer_name: 'Oluwatosin Adegboye', store_name: 'Emeka Pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 2, order_no: 'RHPO-1651244214', customer_name: 'Janet Adeajayi', store_name: 'Emeka Pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 3, order_no: 'RHPO-1651244214', customer_name: 'Henry Christopher', store_name: 'Emeka Pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 4, order_no: 'RHPO-1651244214', customer_name: 'Oluwatosin Adegboye', store_name: 'Emma Bros Pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 5, order_no: 'RHPO-1651244214', customer_name: 'Janet Adeajayi', store_name: 'Emeka Pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 6, order_no: 'RHPO-1651244214', customer_name: 'Henry Christopher', store_name: 'Emma Bros Pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 7, order_no: 'RHPO-1651244214', customer_name: 'Oluwatosin Adegboye', store_name: 'Xela pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 8, order_no: 'RHPO-1651244214', customer_name: 'Janet Adeajayi', store_name: 'Xela pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 9, order_no: 'RHPO-1651244214', customer_name: 'Henry Christopher', store_name: 'Xela pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 10, order_no: 'RHPO-1651244214', customer_name: 'Oluwatosin Adegboye', store_name: 'Emeka Pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 11, order_no: 'RHPO-1651244214', customer_name: 'Janet Adeajayi', store_name: 'Emma Bros Pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 12, order_no: 'RHPO-1651244214', customer_name: 'Henry Christopher', store_name: 'Emeka Pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 13, order_no: 'RHPO-1651244214', customer_name: 'Oluwatosin Adegboye', store_name: 'Emma Bros Pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 14, order_no: 'RHPO-1651244214', customer_name: 'Janet Adeajayi', store_name: 'Xela pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' },
  { id: 15, order_no: 'RHPO-1651244214', customer_name: 'Henry Christopher', store_name: 'Emeka Pharmacy', state: 'Lagos', payment: 'Cheque', order_date: '2025-01-16', delivery_date: '2025-01-16', total_amount: '₦47,400.00' }
]);

// Computed filtered list based on search
const deliveredOrdersList = computed(() => {
  if (!hasSearched.value || !search.value.trim()) {
    return [];
  }
  
  const searchTerm = search.value.trim().toLowerCase();
  const searchBy = selectedSearchBy.value;
  
  return allDeliveredOrders.value.filter(order => {
    if (searchBy === 'order') {
...
<style>
/* Reuse the same styles from Customer Success Delivered Orders */
