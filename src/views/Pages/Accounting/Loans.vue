<template>
  <div class="px-6 erp_dashboard_wrapper">
      ...
      <div class="px-0 mt-0 bg-white min-h-[calc(100vh-190px)]">
        ...
        >
          ...
          <template #column="col">
            ...
            <!-- Requested Loan -->
            <span v-else-if="col.props.column.field === 'requestedLoan'">
              <span class="font-medium">{{ col.props.row.requestedLoan }}</span>
            </span>
            
            <!-- Repaid Loan -->
            <span v-else-if="col.props.column.field === 'repaidLoan'">
              <span class="font-medium">{{ col.props.row.repaidLoan }}</span>
            </span>
            
            <!-- Outstanding Loan -->
            <span v-else-if="col.props.column.field === 'outstandingLoan'">
              <span class="font-medium">{{ col.props.row.outstandingLoan }}</span>
            </span>
            
            <!-- Last 1 Mth. Orders -->
            <span v-else-if="col.props.column.field === 'last1MthOrders'">
              <span class="text-gray-700">{{ col.props.row.last1MthOrders }}</span>
            </span>
            
            <!-- Last 2 Mth. Orders -->
            <span v-else-if="col.props.column.field === 'last2MthOrders'">
              <span class="text-gray-700">{{ col.props.row.last2MthOrders }}</span>
            </span>
            
            <!-- Last 3 Mth. Orders -->
            <span v-else-if="col.props.column.field === 'last3MthOrders'">
              <span class="text-gray-700">{{ col.props.row.last3MthOrders }}</span>
            </span>
    ...
    >
      <template #header>
        <h2 class="text-lg font-medium text-[#172B4D]">Request/Repay Loan</h2>
      </template>
...
const warningMessage = computed(() => {
  ...
  return `You are about to request a new loan of "₦${amount}". Please review and verify the information before proceeding as this action cannot be undone.`;
});

const successMessage = computed(() => {
  const amount = loanForm.value.amount || '0.00';
  return `The loan request of "₦${amount}" has been successfully initiated.`;
});
...
const customerOptions = ref<Option[]>([
  ...
  { id: 4, name: 'Oluwatosin Adegbo' },
  { id: 5, name: 'Jane Doe' },
  { id: 6, name: 'John Smith' },
  { id: 7, name: 'Mary Johnson' },
  { id: 8, name: 'David Brown' },
  { id: 9, name: 'Sarah Wilson' },
  { id: 10, name: 'Michael Davis' }
]);
...
// Mock Customer Loans data
const allLoans = ref([
  { id: 87, customerName: "Emeka Kalu", storeName: "Emeka Pharmacy", requestedLoan: "₦2,055,043.00", repaidLoan: "₦2,055,043.00", outstandingLoan: "₦2,055,043.00", last1MthOrders: "1,000", last2MthOrders: "1,000", last3MthOrders: "1,000" },
  { id: 54, customerName: "Emmanuel Aba", storeName: "Emma Bros Pharmacy", requestedLoan: "₦2,055,043.00", repaidLoan: "₦2,055,043.00", outstandingLoan: "₦2,055,043.00", last1MthOrders: "1,000", last2MthOrders: "1,000", last3MthOrders: "1,000" },
  { id: 25, customerName: "Nyerhovwo Omuvwie", storeName: "Xela pharmacy", requestedLoan: "₦2,055,043.00", repaidLoan: "₦2,055,043.00", outstandingLoan: "₦2,055,043.00", last1MthOrders: "1,000", last2MthOrders: "1,000", last3MthOrders: "1,000" },
  { id: 30, customerName: "Oluwatosin Adegbo", storeName: "Tosin Pharmacy", requestedLoan: "₦2,055,043.00", repaidLoan: "₦2,055,043.00", outstandingLoan: "₦2,055,043.00", last1MthOrders: "1,000", last2MthOrders: "1,000", last3MthOrders: "1,000" },
  { id: 45, customerName: "Jane Doe", storeName: "Jane's Pharmacy", requestedLoan: "₦2,055,043.00", repaidLoan: "₦2,055,043.00", outstandingLoan: "₦2,055,043.00", last1MthOrders: "1,000", last2MthOrders: "1,000", last3MthOrders: "1,000" },
  { id: 56, customerName: "John Smith", storeName: "Smith Medical", requestedLoan: "₦2,055,043.00", repaidLoan: "₦2,055,043.00", outstandingLoan: "₦2,055,043.00", last1MthOrders: "1,000", last2MthOrders: "1,000", last3MthOrders: "1,000" },
  { id: 67, customerName: "Mary Johnson", storeName: "Johnson Health", requestedLoan: "₦2,055,043.00", repaidLoan: "₦2,055,043.00", outstandingLoan: "₦2,055,043.00", last1MthOrders: "1,000", last2MthOrders: "1,000", last3MthOrders: "1,000" },
  { id: 78, customerName: "David Brown", storeName: "Brown Pharmacy", requestedLoan: "₦2,055,043.00", repaidLoan: "₦2,055,043.00", outstandingLoan: "₦2,055,043.00", last1MthOrders: "1,000", last2MthOrders: "1,000", last3MthOrders: "1,000" },
  { id: 89, customerName: "Sarah Wilson", storeName: "Wilson Medical", requestedLoan: "₦2,055,043.00", repaidLoan: "₦2,055,043.00", outstandingLoan: "₦2,055,043.00", last1MthOrders: "1,000", last2MthOrders: "1,000", last3MthOrders: "1,000" },
  { id: 90, customerName: "Michael Davis", storeName: "Davis Health", requestedLoan: "₦2,055,043.00", repaidLoan: "₦2,055,043.00", outstandingLoan: "₦2,055,043.00", last1MthOrders: "1,000", last2MthOrders: "1,000", last3MthOrders: "1,000" }
]);
...
const filteredLoans = computed(() => {
  ...
  return allLoans.value.filter(loan => {
    if (selectedSearchBy.value === 'customer') {
      return loan.customerName.toLowerCase().includes(searchTerm);
    } else {
      return loan.storeName.toLowerCase().includes(searchTerm);
    }
  });
});
...
const loanColumns = ref<TableColumn[]>([
  ...
  { label: 'Requested Loan', field: 'requestedLoan', sortable: true },
  { label: 'Repaid Loan', field: 'repaidLoan', sortable: true },
  { label: 'Outstanding Loan', field: 'outstandingLoan', sortable: true },
  { label: 'Last 1 Mth. Orders', field: 'last1MthOrders', sortable: true },
  { label: 'Last 2 Mth. Orders', field: 'last2MthOrders', sortable: true },
  { label: 'Last 3 Mth. Orders', field: 'last3MthOrders', sortable: true }
]);
