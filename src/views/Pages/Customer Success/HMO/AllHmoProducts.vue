<template>
  <div class="erp_dashboard_wrapper">
    <div class="">
      <!-- Header -->
      <PageTitle title="HMO & Pharmacy / HMO Products" class="px-6" />
    </div>
    ...
    >
      ...
      <template #footer>
        <div class="flex justify-end space-x-3">
          <Button type="gray-btn" :onClick="closeTransferModal">Cancel</Button>
          <Button type="blue-btn" :onClick="handleTransfer">Transfer</Button>
        </div>
      </template>
    </SideBarModal>
