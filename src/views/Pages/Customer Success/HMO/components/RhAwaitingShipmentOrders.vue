<template>
  <div>
    <Datatable
      :items="rhAwaitingShipmentOrders"
      :columns="rhAwaitingShipmentOrderColumns"
      :searchable="true"
      :filterByDate="false"
      :printable="false"
      :exportable="false"
      :filterFields="{}"
      pageName="RhAwaitingShipmentOrders"
      :key="childKey"
    >
      <template #column="col">
        <!-- Action Column -->
...
// Column definitions
const rhAwaitingShipmentOrderColumns = ref<TableColumn[]>([
...
// Mock data
const rhAwaitingShipmentOrders = ref([
  {
...
<style scoped>
/* Add any specific styles for RH Awaiting Shipment Orders */
</style>
