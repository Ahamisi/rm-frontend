<template>
  <div class="flex-1 flex flex-col min-h-0">
    <Datatable
      :items="beingProcessedOrders"
      :columns="columns"
      :pageName="'pharmacy-orders-processing'"
      :searchable="true"
      :filterByDate="true"
      :showActions="true"
      :showPagination="true"
...
const columns: TableColumn[] = [
  ...
  { field: 'processing_started', label: 'Processing Started', sortable: true },
  { field: 'action', label: 'Action', sortable: false }
];

// Mock data for being processed pharmacy orders
const beingProcessedOrders = ref([
  {
    id: 7,
    order_no: 'PO-2025-007',
    pharmacy_name: 'City Pharmacy',
    pharmacist_name: 'Dr. Robert Wilson',
    prescription_no: 'RX-2025-007',
    total_amount: '₦156,300.00',
    processing_started: '2025-01-15',
    status: 'Processing'
  },
  {
    id: 8,
    order_no: 'PO-2025-008',
    pharmacy_name: 'Metro Pharmacy',
    pharmacist_name: 'Dr. Lisa Anderson',
    prescription_no: 'RX-2025-008',
  ...
  {
    id: 9,
    order_no: 'PO-2025-009',
    pharmacy_name: 'Central Pharmacy',
    pharmacist_name: 'Dr. David Miller',
    prescription_no: 'RX-2025-009',
    total_amount: '₦134,750.00',
    processing_started: '2025-01-14',
    status: 'Processing'
  }
]);

const handleSearch = (searchTerm: string) => {
  console.log('Searching processing pharmacy orders:', searchTerm);
};
