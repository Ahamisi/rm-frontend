<template>
  <div class="flex-1 flex flex-col min-h-0">
    <Datatable
      :items="pickedPackedOrders"
      :columns="columns"
      :pageName="'pharmacy-orders-packed'"
      :searchable="true"
      :filterByDate="true"
      :showActions="true"
      :showPagination="true"
...
const columns: TableColumn[] = [
  ...
  { field: 'packed_date', label: 'Packed Date', sortable: true },
  { field: 'action', label: 'Action', sortable: false }
];

// Mock data for picked & packed pharmacy orders
const pickedPackedOrders = ref([
  {
    id: 10,
    order_no: 'PO-2025-010',
    pharmacy_name: 'Sunrise Pharmacy',
    pharmacist_name: 'Dr. Amanda Taylor',
    prescription_no: 'RX-2025-010',
    total_amount: '₦92,400.00',
    packed_date: '2025-01-15',
    status: 'Packed'
  },
  {
    id: 11,
    order_no: 'PO-2025-011',
    pharmacy_name: 'Sunset Pharmacy',
    pharmacist_name: 'Dr. Christopher Lee',
    prescription_no: 'RX-2025-011',
    total_amount: '₦67,800.00',
    packed_date: '2025-01-15',
    status: 'Packed'
  },
  {
    id: 12,
    order_no: 'PO-2025-012',
    pharmacy_name: 'Midnight Pharmacy',
    pharmacist_name: 'Dr. Rachel Green',
    prescription_no: 'RX-2025-012',
    total_amount: '₦145,200.00',
    packed_date: '2025-01-14',
    status: 'Packed'
  }
]);

const handleSearch = (searchTerm: string) => {
  console.log('Searching packed pharmacy orders:', searchTerm);
};
