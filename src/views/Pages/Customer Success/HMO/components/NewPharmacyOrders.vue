...
// Mock data for new pharmacy orders
const newOrders = ref([
  {
    id: 1,
    order_no: 'PO-2025-001',
    pharmacy_name: 'Emeka Pharmacy',
    pharmacist_name: 'Dr. Emeka Kalu',
    prescription_no: 'RX-2025-001',
  ...
  },
  {
    ...
    pharmacy_name: 'Emma Bros Pharmacy',
    pharmacist_name: 'Dr. Emmanuel Aba',
    prescription_no: 'RX-2025-002',
  ...
  },
  {
    ...
    pharmacy_name: 'Xela Pharmacy',
    pharmacist_name: 'Dr. Nyerhovwo Omuvwie',
    prescription_no: 'RX-2025-003',
...
const handleSearch = (searchTerm: string) => {
  console.log('Searching new pharmacy orders:', searchTerm);
};
