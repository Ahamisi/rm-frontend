<template>
  <div class="erp_dashboard_wrapper">
    <div class="grey_bg">
      ...
      <!-- tabs -->
      <Tabs :tabs="partnerOrderTabs" @tab-changed="handleTabChange" :defaultTab="activeTab">
    ...
    <div class="px-6 mt-0 bg-white tab_contents min-h-[calc(100vh-190px)]">
      <Datatable
        ...
        :exportable="false"
        :filterFields="{}"
        pageName="PartnerOrders"
        :key="`partnerorders-${activeTab}-${childKey}`"
      >
        <template #column="col">
          <!-- Action Column -->
    ...
    <UniversalCenteredModal :show="showStatusModal" @close="showStatusModal = false">
      ...
      <template #footer>
        <div class="flex justify-end space-x-3 discard_merge_alert_footer">
          <Button type="gray-btn" :onClick="() => showStatusModal = false">
            Cancel
          </Button>
...
// Status options (matching Partner Orders structure)
const statusOptions = ref([
  { id: 1, name: 'Pending' },
  { id: 2, name: 'Being Processed' },
  { id: 3, name: 'Shipped' },
  { id: 4, name: 'Delivered' },
  { id: 5, name: 'Confirmed' },
  { id: 6, name: 'Cancelled' }
...
// Order items for OrderDetailsModal (matching Partner Orders structure)
...
// Base column definitions for Partner Orders
...
const partnerOrderColumns = computed<TableColumn[]>(() => {
...
const partnerOrders = ref([
  ...
  },
  {
    ...
    rh_order_no: 'RHPO-1651244214',
    partner_name: 'Remedial Partner',
    customer_name: 'EVANS THERAPEUTICS LTD',
    order_date: '5/21/2024',
    processing_date: '5/22/2024',
    total_amount: '₦2,055,043.00'
  },
  {
    ...
    customer_name: 'Emzor Pharmaceuticals',
    order_date: '5/21/2024',
    processing_date: '5/22/2024',
    total_amount: '₦2,055,043.00'
  },
...
const downloadReport = () => {
  toastMessage.value = 'Download Partner Order Report Successful';
  showToast.value = true;
};
