  ...
  <div class="px-6 erp_dashboard_wrapper">
    ...
    <div class="min-h-[calc(100vh-190px)]" v-else>
      <Datatable
        ...
        :key="childKey"
        pageName="CustomerSuccessDeliveredOrders" 
...
const delivered_url = computed(() => {
  const params = new URLSearchParams({
    ...
    filter: JSON.stringify({ state: 'Delivered', department: 'customer-success' })
  });
  return `/customer-success/delivered-orders?${params.toString()}`;
});
