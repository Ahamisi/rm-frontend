<template>
  <div class="erp_dashboard_wrapper">
    <div class="">
      <!-- Header -->
      <PageTitle title="More Actions / Drivers" class="px-6" />
    </div>
        ...
        <template #column="col">
          ...
          <span v-if="col.props?.column?.field === 'driver'">
            <div class="flex items-center gap-2">
              ...
              <span>{{ (col.props?.formattedRow as any)?.driver || '' }}</span>
            </div>
          </span>
          ...
          <span v-else-if="col.props?.column?.field === 'status'">
            <Pill 
              ...
              :type="getStatusType((col.props?.formattedRow as any)?.status)"
            />
          </span>

          <!-- Fines Column -->
          <span v-else-if="col.props?.column?.field === 'fines'">
            {{ formatCurrency((col.props?.formattedRow as any)?.fines || 0) }}
          </span>
...
// Column definitions for Drivers
const driverColumns: TableColumn[] = [
  { label: 'ID', field: 'id', sortable: true },
  { label: 'Driver', field: 'driver', sortable: true },
  { label: 'Average Ratings', field: 'average_ratings', sortable: true },
  { label: 'Phone', field: 'phone', sortable: false },
  { label: 'Assigned Hub', field: 'assigned_hub', sortable: true },
  { label: 'Status', field: 'status', sortable: true },
  { label: 'Fines', field: 'fines', sortable: true }
];

// Mock data for Drivers
const drivers = ref([
  { id: 87, driver: 'Babajide Raji', rating: 5, phone: '+234 899 9999 999', assigned_hub: 'Abuja Hub', status: 'Enabled', fines: 2055043.00 },
  { id: 25, driver: 'Esther Joel', rating: 5, phone: '+234 899 9999 999', assigned_hub: 'Asaba Hub', status: 'Enabled', fines: 2055043.00 },
  { id: 21, driver: 'Femi Babalola', rating: 1, phone: '+234 899 9999 999', assigned_hub: 'Abuja Hub', status: 'Enabled', fines: 2055043.00 },
  { id: 23, driver: 'Sarah Badmus', rating: 2, phone: '+234 899 9999 999', assigned_hub: 'Abuja Hub', status: 'Enabled', fines: 2055043.00 },
  { id: 87, driver: 'Josh Michael', rating: 4, phone: '+234 899 9999 999', assigned_hub: 'Kano Hub', status: 'Pending', fines: 2055043.00 },
  { id: 5, driver: 'System Admin', rating: 5, phone: '+234 899 9999 999', assigned_hub: 'Asaba Hub', status: 'Enabled', fines: 2055043.00 }
]);
...
// Get status type for Pill component
